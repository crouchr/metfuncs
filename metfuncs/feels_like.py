# https://gist.github.com/jfcarr/e68593c92c878257550d
...
def feels_like(vTemperature, vWindSpeed, vRelativeHumidity):
    ...
    if vFeelsLike == vTemperature and vTemperature >= 80:
        ...
        if vFeelsLike >= 80:
            ...
            if vRelativeHumidity < 13 and vTemperature >= 80 and vTemperature <= 112:
                vFeelsLike = vFeelsLike - ((13 - vRelativeHumidity) / 4) * math.sqrt(
                    (17 - math.fabs(vTemperature - 95.)) / 17)
